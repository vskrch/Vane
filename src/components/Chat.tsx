...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col space-y-6 pt-8 pb-56 lg:pb-44 sm:mx-4 md:mx-8">
      ...
      {dividerWidth > 0 && (
        <div
          className="fixed z-40 bottom-24 lg:bottom-4"
          style={{ width: dividerWidth }}
        >
          <div
            className="pointer-events-none absolute -bottom-6 left-0 right-0 h-[calc(100%+32px+32px)] dark:hidden"
            style={{
              background:
          ...
          />
          <div
            className="pointer-events-none absolute -bottom-6 left-0 right-0 h-[calc(100%+32px+32px)] hidden dark:block"
            style={{
              background:
